// NOTE: This file is originally from the Rust bindings for X11 libraries, x11-rs.
// The X11 libraries are available under the MIT license and these bindings are
// public domain.
